...
named with the same slug the course uses. 2 of the 5 ship runnable code;
the rest are written artifacts, and their folder points back at the lesson.

| # | Folder | Kind | |
|---|--------|------|---|
| 1 | [`01-sh-1-welcome`](01-sh-1-welcome) | lesson |  |
| 2 | [`02-sh-2-how-to-use`](02-sh-2-how-to-use) | lesson | runnable |
| 3 | [`03-sh-3-control-and-observability`](03-sh-3-control-and-observability) | lesson | runnable |
