...
named with the same slug the course uses. 2 of the 6 ship runnable code;
the rest are written artifacts, and their folder points back at the lesson.

| # | Folder | Kind | |
|---|--------|------|---|
| 1 | [`01-s11-capstone-clinic`](01-s11-capstone-clinic) | lesson | runnable |
| 2 | [`02-s12-design-review`](02-s12-design-review) | lesson | runnable |
